...
( async () => {
  ...
  // Creates a lock that will be held until the sim is ready to launch. This allows waiting to launch the sim until all
  // resources have loaded (and e.g. images have dimensions, sounds are ready to play, etc.)
  await import( "scenerystack/lock" );
